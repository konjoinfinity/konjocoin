...
#ifndef KONJOCOIN_TEST_SCRIPTNUM10_H
#define KONJOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Konjocoin Core 0.10.0, for cross-comparison.
 */
public:
