...
#ifndef KONJOCOIN_TXMEMPOOL_H
#define KONJOCOIN_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/konjocoin/konjocoin/pull/14193 will fix it. No known code
     * in konjocoin currently depends on second guarantee, but it is important to
