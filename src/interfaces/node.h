...
#ifndef KONJOCOIN_INTERFACES_NODE_H
#define KONJOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a konjocoin node (konjocoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // KONJOCOIN_INTERFACES_NODE_H
