 ...
 */
#ifndef KONJOCOIN_UTIL_SYSTEM_H
#define KONJOCOIN_UTIL_SYSTEM_H
...
extern const char * const KONJOCOIN_CONF_FILENAME;
...
{
    std::string s = strprintf("konjocoin-%s", name);
