...
#if defined(NDEBUG)
# error "Konjocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Konjocoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("konjocoin-scriptch");
