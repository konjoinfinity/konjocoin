...
static void SetupKonjocoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " konjocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  konjocoin-tx [options] <hex-tx> [commands]  Update hex-encoded konjocoin transaction\n" +
            "or:     konjocoin-tx [options] -create [commands]   Create hex-encoded konjocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded konjocoin transaction
