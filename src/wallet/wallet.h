...
#ifndef KONJOCOIN_WALLET_WALLET_H
#define KONJOCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! konjocoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this konjocoin node, and set to 0 for transactions that were created
...
#endif // KONJOCOIN_WALLET_WALLET_H
