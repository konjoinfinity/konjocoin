    ...
    platformStyle(_platformStyle)
{
    ...
    // normal konjocoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying konjocoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &KonjocoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
