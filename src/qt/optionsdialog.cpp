    ...
    mapper(nullptr)
{
    ...
    ui->konjocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->konjocoinAtStartup);
    ...
    ui->konjocoinAtStartup->setToolTip(ui->konjocoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->konjocoinAtStartup->setText(ui->konjocoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openKonjocoinConfButton->setToolTip(ui->openKonjocoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new KonjocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->konjocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKonjocoinConfButton_clicked()
{
