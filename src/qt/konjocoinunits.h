...
#ifndef KONJOCOIN_QT_KONJOCOINUNITS_H
#define KONJOCOIN_QT_KONJOCOINUNITS_H
...
/** Konjocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KonjocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KonjocoinUnits(QObject *parent);

    /** Konjocoin units.
      @note Source: https://en.konjocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef KonjocoinUnits::Unit KonjocoinUnit;

#endif // KONJOCOIN_QT_KONJOCOINUNITS_H
