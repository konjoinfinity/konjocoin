...
[BIP 174 PSBT](https://github.com/konjocoin/bips/blob/master/bip-0174.mediawiki) is an interchange format for Litecoin transactions that are not fully signed
