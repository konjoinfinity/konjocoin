Konjocoin Core version 0.16.2 is now available from:

  <https://download.konjocoin.org/konjocoin-0.16.2/>
...
- #12843 `df38b13` Test starting konjocoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure konjocoind processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` konjocoinconsensus: invalid flags should be set to konjocoinconsensus_error type, add test cases covering konjocoinconsensus error codes (Thomas Kerin)
