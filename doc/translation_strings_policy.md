...
This document provides guidelines for internationalization of the Konjocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `konjocoin_en.ts` remains unchanged.
