Konjocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/konjocoin/files/Konjocoin/konjocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Konjocoin
...
New/changed settings (command-line or konjocoin.conf file)
--------------------------------------------------------
