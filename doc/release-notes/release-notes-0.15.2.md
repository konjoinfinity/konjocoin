Konjocoin Core version *0.15.2* is now available from:

  <https://konjocoincore.org/bin/konjocoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in konjocoin-tx (TheBlueMatt)
