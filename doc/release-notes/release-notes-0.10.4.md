Konjocoin Core version 0.10.4 is now available from:

  <https://konjocoin.org/bin/konjocoin-core-0.10.4/>
...
- #6953 `43c2789` Split konjocoin-tx into its own package
- #6953 `dfe0d4d` Include konjocoin-tx binary on Debian/Ubuntu
