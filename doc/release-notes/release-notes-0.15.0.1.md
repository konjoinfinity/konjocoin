Konjocoin Core version *0.15.0.1* is now available from:

  <https://konjocoin.org/bin/konjocoin-core-0.15.0.1/>

and

  <https://konjocoincore.org/bin/konjocoin-core-0.15.0.1/>
