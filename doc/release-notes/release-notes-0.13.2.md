Konjocoin Core version 0.13.2 is now available from:
  ...
  <https://konjocoin.org/bin/konjocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update konjocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow konjocoin-tx to create v2 transactions (btcdrak)
