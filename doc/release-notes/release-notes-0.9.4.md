Konjocoin Core version 0.9.4 is now available from:

  https://konjocoin.org/bin/0.9.4/
...
this update is incompatible with the Konjocoin system and could lead to consensus
forks.

Konjocoin Core released binaries from https://konjocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~konjocoin/+archive/ubuntu/konjocoin
- A third-party or self-compiled Konjocoin Core

upgrade to Konjocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
