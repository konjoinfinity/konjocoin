...
// konjocoin includes.
#include <..\src\script\konjocoinconsensus.h>
...
int main()
{
    std::cout << "konjocoinconsensus version: " << konjocoinconsensus_version() << std::endl;
    ...
    auto op0Result = konjocoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, konjocoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
