...
KONJOCOIND=${KONJOCOIND:-$BINDIR/konjocoind}
KONJOCOINCLI=${KONJOCOINCLI:-$BINDIR/konjocoin-cli}
KONJOCOINTX=${KONJOCOINTX:-$BINDIR/konjocoin-tx}
WALLET_TOOL=${WALLET_TOOL:-$BINDIR/konjocoin-wallet}
KONJOCOINQT=${KONJOCOINQT:-$BINDIR/qt/konjocoin-qt}
