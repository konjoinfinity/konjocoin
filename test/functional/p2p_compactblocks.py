...
# TestP2PConn: A peer we use to send messages to konjocoind, and store responses.
...
class CompactBlocksTest(KonjocoinTestFramework):
    ...
    # This test actually causes konjocoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that konjocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for konjocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # konjocoind will not send blocktxn responses for blocks whose height is
