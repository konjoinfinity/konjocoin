...
"""Verify that starting konjocoin with -h works as expected."""

from test_framework.test_framework import KonjocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(KonjocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start konjocoin with -h for help text")
        ...
        self.log.info("Start konjocoin with -version for version information")
        ...
        self.log.info("Start konjocoind with -fakearg to make sure it does not start")
