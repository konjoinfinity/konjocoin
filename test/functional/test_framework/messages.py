...
"""Konjocoin test framework primitive and message structures

CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
    data structures that should map to corresponding structures in
    konjocoin/primitives
...
# Objects that map to konjocoind objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in konjocoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class CBlockHeader:
    ...
    def calc_sha256(self):
        if self.sha256 is None:
            ...
            self.scrypt256 = uint256_from_str(konjocoin_scrypt.getPoWHash(r))
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in konjocoind indicates these should be deserialized as blocks
